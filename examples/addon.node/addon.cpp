...
void whisper_print_segment_callback(struct whisper_context *ctx,
    ...
    for (int i = s0; i < n_segments; i++) {
        ...
        if (params.diarize && pcmf32s.size() == 2) {
            ...
            // printf("is0 = %lld, is1 = %lld, energy0 = %f, energy1 = %f,
    ...
    for (int f = 0; f < (int)params.fname_inp.size(); ++f) {
        ...
        // print some info about the processing
        {
            ...
            fprintf(
                ...
                "processors, lang = %s, task = %s, timestamps = %d ...\n",
        ...
        // run the inference
        {
            ...
            // in this example, we do not abort the processing, but we could if
            // the flag is set to true the callback is called before every
            // encoder run - if it returns false, the processing is aborted
            {
...
Napi::Object Init(Napi::Env env, Napi::Object exports) {
    exports.Set(Napi::String::New(env, "whisper"),
